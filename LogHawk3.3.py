...
countErr = 0
countCrit =0
##Cron Variables (add or change as needed)
countCron = 0
#endregion
...
fileName = outputPath + "/" + "LogHawk3.3_" + datetime.now().strftime("%Y-%m-%d_%H-%M") + ".txt"
...
##count lines that include 'Cron' activity (add or change as needed)
...
with open(fileName, "a") as file:
    ...
    file.write(f"\n")
    #Cron Summary
    file.write(f" < Cron Activity Summary > \n")
    file.write(f"\n")
    file.write(f"Cron Activities: {countCron}\n")
